...
export default const render = buildRender(ReactDOM, EventEmitter)

export function buildRender(ReactDOM, EventEmitter) {
  return function render(sources, view, anchor) {
    let store
